...
class _AddNoteState extends State<AddNote> {
  ...
  void _updateNote(){
    ...
    Provider.of<Note>(context, listen: false).updateDetails(_tags, _title, _notebookId);
    setState(() {
      _isLoading = false;
    });
  }
  ...
  void _delete(){
    ...
    Provider.of<Notes>(context, listen: false).deleteNote(widget.noteId);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      if(widget.noteId!= null)(_isLoadingDelete)
